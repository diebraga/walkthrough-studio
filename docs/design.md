...
> Source: [getdesign.md/apple](https://getdesign.md/apple/design-md), via
> [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md)
> (`npx getdesign@latest add apple`). An independent analysis of patterns
> publicly visible on apple.com — not an official Apple document, not
> affiliated with or endorsed by Apple. Used here as a reference starting
> point, not a pixel-exact spec; adjust tokens as this project's UI evolves.
